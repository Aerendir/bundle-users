...
final class UserClassMustImplementHasRolesInterfaceTest extends TestCase
{
    public function testConstructor(): void
    {
        $user      = new \stdClass();
        $exception = new UserClassMustImplementHasRolesInterface($user);

        $this->assertInstanceOf(UserClassMustImplementInterface::class, $exception);
        $this->assertSame(sprintf('The User class "%s" MUST implement the "%s" interface.', \stdClass::class, HasRolesInterface::class), $exception->getMessage());
    }
}
