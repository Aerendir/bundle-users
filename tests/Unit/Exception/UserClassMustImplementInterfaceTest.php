...
final class UserClassMustImplementInterfaceTest extends TestCase
{
    public function testConstructor(): void
    {
        $user      = new \stdClass();
        $interface = 'SomeInterface';
        $exception = new UserClassMustImplementInterface($user, $interface);

        $this->assertInstanceOf(UsersException::class, $exception);
        $this->assertSame(sprintf('The User class "%s" MUST implement the "%s" interface.', \stdClass::class, $interface), $exception->getMessage());
    }
}
